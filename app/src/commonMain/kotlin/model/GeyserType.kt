...
enum class GeyserType(
    ...
    COOL_STEAM(
        type = "steam",
        displayName = Res.string.geyserTypeCoolSteamVent,
        /* Good thing to have for water production. */
        rating = Rating.GOOD
    ),
    HYDROGEN(
        type = "hot_hydrogen",
        displayName = Res.string.geyserTypeHydrogenVent,
        /* Free energy */
        rating = Rating.VERY_GOOD
    ),
    NATURAL_GAS(
        type = "methane",
        displayName = Res.string.geyserTypeNaturalGasGeyser,
        /* Free energy & for cooking */
        rating = Rating.VERY_GOOD
    ),
    CHLORINE(
        type = "chlorine_gas",
        displayName = Res.string.geyserTypeChlorineGasVent,
        /* Has its uses */
        rating = Rating.GOOD
    ),
    HOT_STEAM(
        type = "hot_steam",
        displayName = Res.string.geyserTypeSteamVent,
        /* Usable energy, harder to handle. */
        rating = Rating.GOOD
    ),
    HOT_CO2(
        type = "hot_co2",
        displayName = Res.string.geyserTypeCarbonDioxideVent,
        /* Mostly useless */
        rating = Rating.VERY_BAD
    ),
    HOT_POLLUTED_O2(
        type = "hot_po2",
        displayName = Res.string.geyserTypeHotPollutedOxygenVent,
        /* Crap */
        rating = Rating.VERY_BAD
    ),
    INFECTIOUS_POLLUTED_O2(
        type = "slimy_po2",
        displayName = Res.string.geyserTypeInfectiousPollutedOxygenVent,
        /* Usually does not produce enough to be helpful. */
        rating = Rating.BAD
    ),
    WATER(
        type = "hot_water",
        displayName = Res.string.geyserTypeWaterGeyser,
        /* We love free water */
        rating = Rating.VERY_GOOD
    ),
    COOL_SLUSH_WATER(
        type = "slush_water",
        displayName = Res.string.geyserTypeCoolSlushGeyser,
        /* Cool polluted water, free or germs. */
        rating = Rating.VERY_GOOD
    ),
    POLLUTED_WATER(
        type = "filthy_water",
        displayName = Res.string.geyserTypePollutedWaterVent,
        /* Many plants can directly consume it. */
        rating = Rating.VERY_GOOD
    ),
    COOL_SALT_WATER(
        type = "slush_salt_water",
        displayName = Res.string.geyserTypeCoolSaltSlushGeyser,
        /* Brine brings coolness and salt. */
        rating = Rating.VERY_GOOD
    ),
    HOT_SALT_WATER(
        type = "salt_water",
        displayName = Res.string.geyserTypeSaltWaterGeyser,
        /* It's useful */
        rating = Rating.GOOD
    ),
    LIQUID_CO2(
        type = "liquid_co2",
        displayName = Res.string.geyserTypeCarbonDioxideGeyser,
        /* Source of coolness, but heats up very fast. */
        rating = Rating.NEUTRAL
    ),
    LEAKY_OIL_FISSURE(
        type = "oil_drip",
        displayName = Res.string.geyserTypeLeakyOilFissure,
        /* Doesn't matter if it's there. Does not produce a lot most of the times. */
        rating = Rating.NEUTRAL
    ),
    LIQUID_SULFUR_GEYSER(
        type = "liquid_sulfur",
        displayName = Res.string.geyserTypeLiquidSulfurGeyser
    ),
    IRON_VOLCANO(
        type = "molten_iron",
        displayName = Res.string.geyserTypeIronVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    COPPER_VOLCANO(
        type = "molten_copper",
        displayName = Res.string.geyserTypeCopperVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    GOLD_VOLCANO(
        type = "molten_gold",
        displayName = Res.string.geyserTypeGoldVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    ALUMINIUM_VOLCANO(
        type = "molten_aluminum",
        displayName = Res.string.geyserTypeAluminiumVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    COBALT_VOLCANO(
        type = "molten_cobalt",
        displayName = Res.string.geyserTypeCobaltVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    TUNGSTEN_VOLCANO(
        type = "molten_tungsten",
        displayName = Res.string.geyserTypeTungstenVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    NIOBIUM_VOLCANO(
        type = "molten_niobium",
        displayName = Res.string.geyserTypeNiobiumVolcano,
        /* Metal geysers are good. */
        rating = Rating.GOOD
    ),
    VOLCANO(
        type = "big_volcano",
        displayName = Res.string.geyserTypeVolcano
    ),
    MINOR_VOLCANO(
        type = "small_volcano",
        displayName = Res.string.geyserTypeMinorVolcano
    ),
    OIL_RESERVOIR(
        type = "OilWell",
        displayName = Res.string.geyserTypeOilReservoir,
